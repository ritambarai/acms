...
<Settings>
  ...
  <row><mqtt><Host>mqtt-server.ddns.net</Host><Port>1883</Port><Data_Topic>ACMS_Rey/01/</Data_Topic><Alert_Topic>ACMS_Rey/01/</Alert_Topic><Mqtt_Username></Mqtt_Username><Mqtt_Password></Mqtt_Password></mqtt></row>
  <row><json includes><Metadata>true</Metadata><Constraints>false</Constraints><Type_Unit>true</Type_Unit></json includes></row>
</Settings>
)XMLRAW";
