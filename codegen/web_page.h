...
<div class="half">
  ...
  <div class="subcat-row">
    <span class="subcat-label">values</span>
    <div class="form-grid">
    <div class="field">
      <label>Value</label>
